...
This course is structured modularly. Each main topic from the MO-211 exam has its own folder containing:
1. A **README.md** with the lesson concepts and step-by-step instructions.
2. **Starter Excel files** (`.xlsx`) to practice on.
3. **Solution files** so you can check your work.

To get started, simply clone this repository or download the ZIP file, and work through the modules below in order.
